...
namespace GOClubs.Models
{
    public partial class GOClubsContext : DbContext
    {
        public GOClubsContext()
        {
        }

        public GOClubsContext(DbContextOptions<GOClubsContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=localhost\\SQL2019;Database=Clubs;Trusted_Connection=True;");
            }
        }
